...
export type ProviderNeutralImagePromptMode = 'GENERATE' | 'EDIT';
export type ProviderNeutralImagePromptProfile = 'FULL' | 'COMPACT';

export type ProviderNeutralImagePromptWarningCode =
  | 'CAMERA_UNSPECIFIED'
...
export interface ProviderNeutralImagePromptWarning {
  code: ProviderNeutralImagePromptWarningCode;
  message: string;
}

export interface ProviderNeutralImagePromptAdapterOptions {
  mode: ProviderNeutralImagePromptMode;
  profile?: ProviderNeutralImagePromptProfile;
}

export interface ProviderNeutralImagePromptOutput {
  ...
  warnings: ProviderNeutralImagePromptWarning[];
}
...
function warningsFor(
  ...
  mode: ProviderNeutralImagePromptMode,
): ProviderNeutralImagePromptWarning[] {
  const warnings: ProviderNeutralImagePromptWarning[] = [];
...
function fullPrompt(
  ...
  const parts = [
    ...
    section('IMAGE REALISM', uniqueSorted([
...
export function adaptCanonicalImagePromptToProviderNeutral(
  spec: CanonicalImagePromptSpec,
  options: ProviderNeutralImagePromptAdapterOptions,
): ProviderNeutralImagePromptOutput {

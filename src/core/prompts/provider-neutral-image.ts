import { Scene, Stage, WorldState, ProjectDNA, SpatialMap, ProviderNeutralImagePrompt } from '../types';

/**
 * Gera prompt de imagem provider-neutral deterministicamente a partir dos dados do sistema.
 * Regra: MODIFICAR somente o necessário; PRESERVAR todo o restante.
 */
export function generateProviderNeutralImagePrompt(
  scene: Scene,
  stage: Stage,
